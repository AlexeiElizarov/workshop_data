...
from .views import *
urlpatterns = [
    path('data_autocomplete_product/', ProductAutocomplete.as_view(create_field='name'), name='data_autocomplete_product'),
    ...
    path('new_detail-complite/', detaile_create_complite, name='create_new_detail_complite'),
    path('new_product/', ProductCreateView.as_view(), name='create_new_product'),
