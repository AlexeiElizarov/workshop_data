# Generated by Django 4.0.6 on 2022-12-07 15:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sos', models.BooleanField(default=False)),
                ('year', models.PositiveIntegerField(default=2022, validators=[django.core.validators.MinValueValidator(2022), workshop_data.services.general_services.max_value_current_year])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_of_work_stage', models.SmallIntegerField(blank=True, default=0, verbose_name='Время')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='workshop_data.product', verbose_name='Изделие')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='Рабочий')),
            ],
        ),
        migrations.CreateModel(
            name='Node',
