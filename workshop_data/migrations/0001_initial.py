# Generated by Django 4.0.6 on 2022-09-17 13:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detail', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='workshop_data.detail', verbose_name='Деталь')),
            ],
        ),
        migrations.CreateModel(
            name='WorkshopPlan',
            fields=[
                ...
                ('detail', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='workshop_data.detail')),
                ('product', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='workshop_data.product', verbose_name='_Изделие_')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('batch', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='workshop_data.batchdetailinplan')),
                ('comment_in_batch', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='workshop_data.comment')),
                ('stage_in_batch', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='workshop_data.stagemanufacturingdetail')),
                ('worker', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Рабочий')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
        ...
        migrations.AddField(
            model_name='batchdetailinplan',
            name='detail',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='workshop_data.workshopplan'),
        ),
    ]
