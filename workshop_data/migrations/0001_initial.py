# Generated by Django 4.0.6 on 2023-02-02 16:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detail', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='stages_detail', to='workshop_data.detail', verbose_name='Деталь')),
            ],
        ),
        migrations.CreateModel(
            name='WorkshopPlan',
            fields=[
                ...
                ('detail', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='workshop_data.detail', verbose_name='Деталь')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='workshop_data.product')),
            ],
        ),
        migrations.AddField(
            model_name='product',
            name='detail',
            field=models.ManyToManyField(related_name='detail_in_product', through='workshop_data.ProductDetail', to='workshop_data.detail'),
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantity', models.SmallIntegerField(default=1)),
                ('main_detail', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='workshop_data.detail')),
                ('secondary_detail', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='secondary_detail_in_main', to='workshop_data.detail')),
            ],
        ),
        migrations.AddField(
            model_name='detail',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='detail_in_detail', through='workshop_data.DetailDetail', to='workshop_data.detail'),
        ),
        migrations.CreateModel(
            name='Bonus',
            fields=[
        ...
        migrations.AddField(
            model_name='batchdetailinplan',
            name='detail',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='detail_in_batchs', to='workshop_data.detail', verbose_name='Деталь'),
        ),
        migrations.AddField(
            model_name='batchdetailinplan',
