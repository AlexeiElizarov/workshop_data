<<<<<<< HEAD
# Generated by Django 4.0.6 on 2022-11-13 07:46
=======
...
>>>>>>> origin/master
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='uesr_batch', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Партия',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('month', models.PositiveSmallIntegerField(choices=[(1, 'январь'), (2, 'февраль'), (3, 'март'), (4, 'апрель'), (5, 'май'), (6, 'июнь'), (7, 'июль'), (8, 'август'), (9, 'сентябрь'), (10, 'октябрь'), (11, 'ноябрь'), (12, 'декабрь'), (13, 'не указан')], default=13, verbose_name='_Месяц_')),
                ('sos', models.BooleanField(default=False)),
<<<<<<< HEAD
                ('year', models.PositiveIntegerField(default=2022, validators=[django.core.validators.MinValueValidator(2022), workshop_data.services.services.max_value_current_year])),
...
>>>>>>> origin/master
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('batch', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='workshop_data.batchdetailinplan', verbose_name='Партия')),
